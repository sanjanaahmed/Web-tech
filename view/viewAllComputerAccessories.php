...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">Computer Accessories</font><br><br><br>
                        ...
                        <?php 
                                if(mysqli_num_rows($result)>0){
                                    while($crow=mysqli_fetch_assoc($result)){
                                        ...
                                        <a href=\"product-page.php?pid=$pid\"><font color=\"black\" face=\"times new roman\" size=\"6\">$title</font></a><br><br>
                                    ...
                                    echo"<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Accessories Found</font></td></tr>";
                                }
                                ?>
                </table><br><br><br>
    </center>
